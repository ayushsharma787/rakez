  ...
  render() {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-stone-950 p-6 text-center text-stone-100">
        <div className="max-w-md rounded-3xl bg-stone-900 p-6 shadow-2xl">
          <p className="text-lg font-bold">The scorecard hit an error while rendering.</p>
          <p className="mt-2 text-sm text-stone-300">Reload the page. If it persists, this is the message to report:</p>
          ...
          <button className="mt-4 rounded-2xl bg-teal-700 px-5 py-2.5 text-sm font-bold text-white" onClick={() => window.location.reload()}>
            Reload
          </button>
        </div>
      </div>
